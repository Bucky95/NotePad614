...
public class MainActivity extends BaseActivity implements OnItemClickListener, OnItemLongClickListener {
                            ...
                            new AlertDialog.Builder(MainActivity.this)
                                    ...
                                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            else Toast.makeText(context, "重复的标签名!", Toast.LENGTH_SHORT).show();
                                        }
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                        if (position > 4) {
                            ...
                            del.setOnClickListener(new OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    new AlertDialog.Builder(MainActivity.this)
                                            .setMessage("标签被删除后，标签内的笔记将会移至默认标签！")
                                            .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                                @Override
                                                public void onClick(DialogInterface dialog, int which) {
                                                    int tag = position + 1;
    ...
    private void refreshLvVisibility() {
        ...
        if(temp) myToolbar.setTitle("所有待办");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        final String itemName = (mode == 1 ? "笔记" : "待办");
                ...
                if (view != null) {
                    view.setOnLongClickListener(new View.OnLongClickListener() {
                        ...
                        public boolean onLongClick(View v) {
                            ...
                            builder.setTitle("是否删除所有"+ itemName);
